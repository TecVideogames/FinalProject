...
public class Base {
     ...
     * 
     * @param graGrafico    objeto de la clase <code>Graphics</code> 
     * para graficar
    ...
    public void paint(Graphics graGrafico, ImageObserver imoObserver) {
        graGrafico.drawImage(getImagen(), getX(), getY(), 
     ...
     * intersecta
     * 
     * Metodo que checa si un objeto Base intersecta a otro Base
     * 
     * @param objBase es un objeto de la clase <code>Object</code>
     * @return un valor <code>boolean</code> indicando si se intersecta con este
     *  
     */
    public boolean intersecta(Object objBase) {
        // valido si el objecto es Base
